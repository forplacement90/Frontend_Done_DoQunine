...
export default function Message() {
  ...
  return (
    <>
    <SubComponent/>
    <div className="min-h-screen bg-white text-gray-900 flex flex-col items-center p-6 mt-12">
      <div className="bg-blue-300 w-full max-w-4xl rounded-lg shadow-lg p-4 mt-20">
        <div className="flex justify-between items-center border-b border-gray-700 pb-3">
          ...
          <div className="relative">
            <button 
              className="px-3 py-1 bg-blue-500 rounded-md flex items-center gap-2"
              onClick={() => setDropdownOpen(!dropdownOpen)}
            >
              Filter <IoIosArrowDown />
            </button>
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-40 bg-blue-500 rounded-md shadow-lg p-2">
        ...
        <div className="flex flex-col gap-2 mt-4">
          <div className="flex items-center justify-between bg-blue-500 p-3 rounded-lg">
